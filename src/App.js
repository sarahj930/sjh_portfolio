    ...
    return (
      <Router>
        ...
        <div className="App">
          ...
          // The details page I implemented (for KST Affinity project)
...
function Navbar() {
  return (
    <div className="Nav">
      ...
      <ReactBootStrap.Navbar.Brand href="/sjh_portfolio/#/">Sarah Jessamyn Hand</ReactBootStrap.Navbar.Brand>
      ...
      <ReactBootStrap.Nav>
      <ReactBootStrap.Nav.Link href="/sjh_portfolio/#/">My Work</ReactBootStrap.Nav.Link>
      <ReactBootStrap.Nav.Link href="/sjh_portfolio/#/aboutMe">About Me</ReactBootStrap.Nav.Link>
      <ReactBootStrap.Nav.Link href="Sarah-Hand-Resume-Fall-2020.pdf" download>Resume</ReactBootStrap.Nav.Link>
      <ReactBootStrap.Nav.Link href="/sjh_portfolio/#/contact">Contact</ReactBootStrap.Nav.Link>
      </ReactBootStrap.Nav>
        ...
        <ReactBootStrap.Row>
          ...
          <ReactBootStrap.Col sm={12} xs={12}>
            <div id="project-names">
              ...
              <ReactBootStrap.Image id="carrot-down" src={props.carrotYes} fluid/>
              </div>
            </div>
          </ReactBootStrap.Col>
        </ReactBootStrap.Row>
...
{/*Footer - Reusable component for static project data*/}
...
{/*Contact info - Reusable component for static project data*/}
function ContactFooter(props) {
  return (
    <div id={props.color}>
      <a name="Contact"></a>
      <ReactBootStrap.Container fluid>
        <ReactBootStrap.Row className="align-me" fluid>
          <ReactBootStrap.Col id="contact" sm={12} xs={12} md={6} lg={6}>
        <h1>Hey! Let's get in touch.</h1>
        <br></br>
        <h2>
          <a href="https://www.linkedin.com/in/sarahjessamynhand" className="link">
        ...
        <ReactBootStrap.Col id="grana" sm={12} xs={12} md={6} lg={6}>
          <ReactBootStrap.Image src="granada.png" fluid/>
        </ReactBootStrap.Col>
